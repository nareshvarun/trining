...
var namesWithZ=names.forEach(function(name){
  var ZNames = 0;
  if(name[0]==="z"){
   ZNames += 1;
 }
...
function countVowels(str) {
 var names = /[aeiou]/gi;
 return str.match(names).length;
}
var maxVowelCount = names.forEach(function(name){
var countOfmaxVowelsInName = 0;
})
else{
countOfmaxVowelsInName += 0;
}
return countOfmaxVowelsInName;
})
console.log(names);
